...
open class Device {
    ...
    static public var isGreaterOrEqualTo4_7Inch: Bool {
        return Device.size() >= DeviceSize.screen4_7Inch
    }

    static public var isGreatOrEqualToiPhoneX: Bool {
        return DeviceSize.screen5_8Inch ... DeviceSize.screen6_5Inch ~= size()
    }
}
